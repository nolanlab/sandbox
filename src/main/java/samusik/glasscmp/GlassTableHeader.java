 ...
 * @author Nikolay
 */
public class GlassTableHeader extends DefaultTableCellRenderer{
    ...
    private GradientPaint gp1 , gp3, gp4, gp5;
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if(column >= table.getColumnCount()) return this;
        try{
    ...
    public GlassTableHeader(final JTableHeader header) {
        setOpaque(true);
        ...
        header.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                GlassTableHeader.this.column = table.convertColumnIndexToModel(viewColumn);
    ...
    g2.setFont(this.getFont().deriveFont(this.getHeight()-4.0f));
    g2.setClip(0,0,(int)Math.min(g2.getClip().getBounds2D().getWidth(), this.getWidth()-2), this.getHeight());
    g2.setPaint(gp3);
    g.drawString(this.getText(),4,(int)(this.getHeight()/2.0 + strBounds.getHeight()/2.0)-1);
    g2.setPaint(new Color(255,255,255));
    g2.drawString(this.getText(),3,(int)(this.getHeight()/2.0 + strBounds.getHeight()/2.0)-2);
    g2.drawString(this.getText(),3,(int)(this.getHeight()/2.0 + strBounds.getHeight()/2.0)-2);
