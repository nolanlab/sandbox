 ...
 * @author VeRaptor
 */
public class GlassComboBox extends javax.swing.JComboBox implements Serializable {
    /*
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.getModel().getSelectedItem() != null){
            Rectangle2D strBounds = g.getFontMetrics().getStringBounds(this.getModel().getSelectedItem().toString(),g);
            g2.setPaint(this.getForeground());
            g2.setClip(0, 0, this.getWidth()-25, this.getHeight()+5);
            g2.drawString(Integer.valueOf(this.getSelectedIndex()+1) + ". " + this.getModel().getSelectedItem().toString(),this.borderWidth + 3, (float)(this.getHeight()/2 + strBounds.getHeight()/3.2));
